#pragma checksum "C:\Users\Anjar\Documents\My Appl\MiniInvoice\MiniInvoice\Pages\Main\Invoice.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6828e368845f42983e06b25446d722841cc334e9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6828e368845f42983e06b25446d722841cc334e9", @"/Pages/Main/Invoice.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"col-md-4\">\r\n        <img");
            BeginWriteAttribute("src", " src=\"", 600, "\"", 649, 1);
#nullable restore
#line 17 "C:\Users\Anjar\Documents\My Appl\MiniInvoice\MiniInvoice\Pages\Main\Invoice.cshtml"
WriteAttributeValue("", 606, Url.Content("~/images/freelancerLogo.png"), 606, 43, false);
...
<div class=""row"">
    <fieldset>
        <table id=""detailTable"" class=""table "">
            ...
            BeginWriteAttribute("value", " value=\"", 4070, "\"", 4078, 0);
            EndWriteAttribute();
            ...
            BeginWriteAttribute("value", " value=\"", 4623, "\"", 4631, 0);
            EndWriteAttribute();
            WriteLiteral(@" required=""required""  onkeypress=""this.value=numberFormat(this.value);""/>
                    </div>
                </td>
...
<script type=""text/javascript"">
    ...
    function numberFormat(nr) {
        ...
        nr = nr.replace(regex, '');
       ");
            WriteLiteral(@" //force it to be a string
        nr += '';
    ...
    Date");
            WriteLiteral(@".prototype.addDays = function (days) {
    ...
    function loadDateToList() {
        ...
        $.each(available, function () {
            ...
            if (dateFormat(this, ""yyyy-mm-dd"") == dateFormat(min, ""yyyy-mm-dd"")) {
               ");
            WriteLiteral(@" clause = 'immediately';
            } else {
   ...
   ");
            WriteLiteral(@"                 $('#lblDiscount').val(this['Discount']);
    ...
    function saveDataHeader() {
       ...
       ");
            WriteLiteral(@" //Param untuk update
        if ($('PO_H_ID').val() != '') {
    ...
    $(fu");
        ...
        $('#add').click(function () {
            $('<tr id=""tablerow' + counter + '""><td>' +
                ...
                '</td>' +
                '<td>' +
                '<input type=""text"" class=""text-box single-line"" id=""txtTbl_");
            WriteLiteral(@"Amount[' + counter + ']"" value="""" required=""required"" onkeypress=""this.value=numberFormat(this.value);""/>' +
                '</td>' +
                '<td>' +
