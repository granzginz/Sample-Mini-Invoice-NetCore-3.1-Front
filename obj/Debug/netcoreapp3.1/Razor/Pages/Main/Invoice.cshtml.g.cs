#pragma checksum "C:\Users\Anjar\Documents\My Appl\MiniInvoice\MiniInvoice\Pages\Main\Invoice.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9ab1b746f23de433a1c9a9c9c1ada54bea1388a5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9ab1b746f23de433a1c9a9c9c1ada54bea1388a5", @"/Pages/Main/Invoice.cshtml")]
    ...
    function saveDataDetail(PO_H_ID) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (resData['message'] != 'Unauthorized') {
                    aler");
            WriteLiteral(@"t(resData['message']);
                }
    ...
    $(function () {
        $('#add').click(function () {
            $('<tr id=""tablerow' + counter + '""><td>' +
                ...
                '</td>' +
                '<td>' +
                '<input type=""text"" class=""text-box single-line"" id=");
            WriteLiteral(@"""txtTbl_Qty[' + counter + ']"" value="""" required=""required"" onkeypress=""this.value=numberFormat(this.value);""/>' +
                '</td>' +
                '<td>' +
        ...
        $(""#cboCustomer"").change(function () {
            ...
            $('#imgLogo').prop('src");
            WriteLiteral(@"', '/images/' + e[1] + 'Logo' + '.png');
